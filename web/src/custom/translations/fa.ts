...
export const fa = {
    ...
    'page.body.trade.header.newOrder.content.lastPrice': 'آخرین قیمت بازار',
    ...
    'page.body.landing.marketInfo.title.text1': 'به بازار معاملاتی رادین خوش آمدید',
    ...
    'page.body.landing.features.title': 'Radin ویژگی های پلتفرم',
    ...
    'page.body.landing.features.features.item1.text': 'Radin offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'Radin offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text1': 'پلتفرم ما به گونه ای بهینه سازی شده تا تبادل را از هر دستگاهی ممکن سازد.',
    ...
    'page.body.landing.footer.rights': 'رادین © تمامی حقوق محفوظ می باشد',
    ...
    'page.body.wallets.tabs.deposit.ccy.message.submit': 'آدرس کیف پول شما در کادر زیر قابل مشاهده است. برای واریز' +
    ...
    'page.body.wallets.tabs.withdraw.content.balance': 'موجودی',
    ...
    'page.body.wallets.beneficiaries.confirmationModal.body.text': 'یک ایمیل حاوی کد تأیید برای شما ارسال شده، لطفاً کد مورد نظر را در قسمت زیر برای ذخیره آدرس جدید وارد کنید',
    ...
    'page.body.wallets.beneficiaries.failAddModal.content': 'برای اضافه کردن آدرس کیف پول جدید باید حساب خود را تأیید کنید',
    ...
    'page.body.history.deposit.content.status.collected': 'تایید شده',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.message.1': 'Google Authenticator' + ' را از اینجا دانلود کنید',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.or': 'یا ',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.2': 'QR کد را اسکن کنید و یا از کد MFA استفاده نمایید.',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.3': '* این رمز را در یک جای امن نگهداری کنید. می‌توانید از این کد استفاده نمایید تا از یک دستگاه دیگر به 2FA دسترسی پیدا کنید.',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.modalBody': 'برای غیر فعال کردن با ادمین تماس بگیرید',
    ...
    'page.body.profile.apiKeys.modal.secret_key_info': 'این اطلاعات تنها یک بار نمایش داده می‌شود و در صورت گم شدن دیگر قابل بازیابی نخواهد بود',
 ...
 اگر کلید دستری خود را فراموش کردید، لطفاً آن را حذف کرده و درخواست یک کلید دستری جدید نمایید`,
    ...
    'page.body.profile.content.warning': 'به منظور معامله و استفاده از امکانات سامانه ، اطلاعات حساب کاربری شما باید دقیقا مطابق کارت ملی تکمیل شود.',
    ...
    'page.body.profile.content.bankInfo.warning': 'دقت شود شماره کارت و شماره شبا وارده حتما باید متعلق به شما و متصل به یک حساب بانکی یکسان باشد. شماره کارت وشماره شبا را بدون فاصله و خط تیره وارد کنید.',
    ...
    'page.body.profile.content.bankInfo.acc_num': 'شماره حساب',
    ...
    'page.body.profile.verification.email.subtitle': 'برداشت مجاز',
    'page.body.profile.verification.email.rejected.tooltip': 'ایمیل شما رد شد',
    'page.body.profile.verification.phone.title': 'تایید شماره',
    'page.body.profile.verification.phone.subtitle': 'امکان واربز و ترید',
    'page.body.profile.verification.phone.rejected.tooltip': 'تلفن شما رد شد',
    'page.body.profile.verification.profile.title': 'تکمیل پروفایل',
    'page.body.profile.verification.profile.subtitle': ' ',
    'page.body.profile.verification.profile.rejected.tooltip': 'پروفایل شما رد شد',
    'page.body.profile.verification.document.title': 'تایید هویت',
    'page.body.profile.verification.document.subtitle': 'افزایش سقف برداشت تا 10 btc',
    'page.body.profile.verification.document.rejected.tooltip': 'Your identity was rejected',
    'page.body.profile.verification.address.title': 'تایید آدرس',
    'page.body.profile.verification.address.subtitle': 'افزایش سقف برداشت تا 100 btc',
    ...
    'page.body.referral.cards.history.header': 'تاریخچه دریافت پاداش ها',
    'page.body.referral.cards.history.table.countOfFriends': 'تعداد دوستان شما',
    'page.body.referral.cards.history.table.countOfRefTrades': 'تعداد معامله دوسنان شما',
    'page.body.referral.cards.history.table.amountOfRef': 'میزان کارمزد دریافتی شما',
    ...
    'page.body.referral.cards.friends.body.text': 'کاربر محترم رادین، ما قصد داریم به کمک شما بازار رادین را گسترده‌تر کنیم. هرچه افراد بیشتری به این پلتفرم وارد شوند، به تدریج قیمت‌ها به سمت عادلانه‌تر شدن پیش خواهد رفت و در نهایت این به نفع تمام کاربران خواهد بود. رادین طرحی به نام معرفی دوستان در نظر گرفته است که هم از طریق آن به گسترش رادین کمک می‌کنید و هم از مزایای آن بهره‌مند می‌‍شوید.',
    'page.body.referral.cards.referral.body.text.firstparagraph': 'شما می‌توانید دوستان خود را با لینک اختصاصی رادین دعوت کنید.',
    'page.body.referral.cards.referral.body.text.secondparagraph': 'درحال حاضر براساس این طرح، ۳۰% از کارمزد تمامی معاملات کسانی که با این لینک ثبت نام کرده‌اند به شما پرداخت خواهد شد.',
    'page.body.referral.cards.introduced.body.text': 'اگر شما توسط یکی از کاربران رادین با سایت ما آشنا شده‌اید، می‌توانید با وارد کردن کد این کاربر وی را به عنوان معرف خود تعیین نمایید. با تعیین معرف، بدون هیچ هزینه‌ی اضافی برای شما، درصدی از کارمزد معاملات شما به معرف شما اختصاص خواهد یافت.',
    ...
    'page.body.deposit.online.text.responsibility': 'مسئولیت مشکلات ناشی از عدم توجه به این موارد بر عهده‌ی مشتری خواهد بود.',
    'page.body.deposit.online.text.useGateway': 'جهت افزایش اعتبار کیف پول ریالی خود با استفاده از کارت‌های بانکی عضو شبکه شتاب و از طریق درگاه پرداخت اینترنتی اقدام نمایید.',
    'page.body.deposit.online.text.payAttention': 'در هنگام پرداخت به نکات زیر دقت نمایید:',
    'page.body.deposit.online.text.shaparak': 'حتماً به آدرس صفحه‌ی درگاه بانکی دقت نموده و تنها پس از اطمینان از حضور در سایت‌های سامانه‌ی شاپرک مشخصات کارت بانکی خود را وارد نمایید.',
    'page.body.deposit.online.text.trueAmount': 'در صفحه درگاه دقت کنید که حتما مبلغ نمایش داده شده درست باشد.',
    'page.body.deposit.online.text.MinTransactionAmount': ' در تعیین مبلغ واریز به این موضوع دقت نمایید که حداقل مبلغ معامله در بازار رادین صد هزار تومان است.',
    'page.body.deposit.online.text.useCard': 'جهت واریز وجه، حتما باید از کارت‌های بانکی به نام خودتان که در پروفایل‌تان ثبت و تایید شده است، استفاده نمایید.',
    ...
    'page.body.deposit.offline.text.useAccount': 'شما مشتریان گرامی می‌توانید، با واریز وجه به صورت مستقیم به حساب بانکی نیز کیف پول ریالی خود را شارژ نمایید. ',
    ...
    'page.body.deposit.offline.text.register': 'واریز حتماً از حساب بانکی به نام خودتان و از حساب‌هایی باشد که در پروفایل خود ثبت نموده‌اید. (در حال حاضر دو حساب بانکی برای شما تایید شده است.)',
    'page.body.deposit.offline.text.trueEntery': 'هنگام واریز حتماً توجه کنید که اطلاعات حساب مقصد مجموعه نوبیتکس را به درستی وارد نمایید.',
    ...
    'page.body.withdraw.coin.input.walletAddress.payAttention': 'توجه: وارد کردن آدرس نادرست ممکن است منجر به از دست رفتن منابع مالی شما شود.',
    'page.body.withdraw.coin.input.walletAddress.selectAccount': 'می‌توانید هر یک از حساب‌های بانکی تایید شده‌ی خود را برای دریافت وجه انتخاب نمایید. در صورتی که حساب مد نظر شما در این لیست نیست، به پروفایل خود رفته و حساب خود را افزوده و منتظر تایید آن باشید.',
    'page.body.withdraw.coin.input.wage.text': 'کارمزد انتقال مربوط به ثبت تراکنش در شبکه‌ی بیت‌کوین بوده و رادین در آن ذینفع نیست.',
    'page.body.withdraw.coin.form.alert': 'در صورتی که آدرس مقصد متعلق به کاربران رادین بوده و توسط رادین مدیریت شود، انتقال به صورت مستقیم و سریع صورت می‌گیرد و کارمزد انتقال صفر خواهد بود.',
    ...
    'page.body.withdraw.fiat.title.firstLine': 'در صورت تمایل به برداشت موجودی کیف پول‌های خود، درخواست خود را اینجا ثبت نمایید.',
    'page.body.withdraw.fiat.title.secondtLine': 'در صورت ثبت حساب بانک آینده و استفاده از آن، معمولا امکان انتقال داخل بانکی و تسریع درخواست برداشت وجود دارد.',
    ...
    'page.body.withdraw.fiat.input.accountAddress.selectAccountText': 'می‌توانید هر یک از حساب‌های بانکی تایید شده‌ی خود را برای دریافت وجه انتخاب نمایید. در صورتی که حساب مد نظر شما در این لیست نیست، به پروفایل خود رفته و حساب خود را افزوده و منتظر تایید آن باشید.',
    ...
    'page.header.signUp.password.message.error': 'رمز عبور باید حداقل شامل 8 کاراکتر باشد، از جمله حداقل یک حرف بزرگ و یک عدد',
    ...
    'page.header.signUp.modal.body': 'برای کامل کردن ثبت نام خود:' +
    ...
    'page.body.coins.rdc': 'رادین کوین',
    'page.body.coins.uni': 'یونی سواپ',
    'page.body.coins.1inch': '1inch',

    'sentry.report_feedback': 'ارجاع خطا',

    // metamask
    'metamask.success.connected': '[MetaMask] با موفقیت وصل شد',

    'metamask.error.noExtension': '[MetaMask] افزونه اتریومی یافت نشد.لطفا افزونه را نصب کرده یا از مروگرهای dApp استفاده کنید',
    'metamask.error.unsupportedNetwork': '[MetaMask] شبکه ای که شما وصل شده اید پشتیبانی نمیشود',
    'metamask.error.unauthorized': '[MetaMask] لطفااجازه دسترسی به اکانت اتریوم خود را بدهید',
    'metamask.error.unknown': '[MetaMask] ارور ناشناخته',
