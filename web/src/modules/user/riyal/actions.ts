...
export const cardVerifyPost = (payload: CardVerifyPostAction['payload']): CardVerifyPostAction => ({
    type: CARD_VERIFY,
    payload,
});


export const cardVerifyData = (payload: CardVerifyDataAction['payload']): CardVerifyDataAction => ({
...
export const getawayFetch = (payload: GetawayFetch['payload']): GetawayFetch => ({
    type: GETAWAY_FETCH,
    payload,
});
...
export const getawayError = (payload: GetawayError['payload']): GetawayError => ({
    type: GETAWAY_ERROR,
    payload,
});
