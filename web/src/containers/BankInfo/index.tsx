...
import {BanksCards} from 'src/helpers/banksCards';
import {IntlProps} from 'src/index';
            ...
            <>
                <div className="card my-3">
                    <div className="card-header">
                        <h3>{this.translate('page.body.profile.content.bankInfo.header')}</h3>
                    </div>
...
const BankInfoConnected = injectIntl(connect(mapStateToProps, mapDispatchToProps)(BankInfoComponent));

export const BankInfo = withRouter(BankInfoConnected as any);
